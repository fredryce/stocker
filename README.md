...
# Stocker
Python script to trade stocks using different strategies through webull api.

## Disclaimer
* This project is intended for research purposes, we take no responsibility or liability for any monetary loss.
